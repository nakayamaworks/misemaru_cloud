...
const DICT = {
  ja: {
    ...
    createStepSpreadsheet: "テンプレートスプレッドシートをコピーします。",
    createStepDeploy: "GAS をウェブアプリとしてデプロイし、URL を控えます。",
    createStepRegistry: "店舗情報を運営へ送信し、認証を申請します。",

    copyStep1: "下のテンプレートを開き、「ファイル → コピーを作成」をクリックします。",
    copyStep2: "自分の Google ドライブに保存します。",
    copyStep3: "コピーした瞬間に Apps Script プロジェクトが自動生成されます。",
  ...
  en: {
    ...
    createStepSpreadsheet: "Copy the template spreadsheet.",
    ...
    copyStep1: "Open the template below and choose “File → Make a copy”.",
    copyStep2: "Save it to your Google Drive.",
    copyStep3: "A linked Apps Script project will be created automatically.",
  ...
  "zh-CN": {
    ...
    createStepSpreadsheet: "复制模板表格。",
    createStepDeploy: "将 GAS 部署为网络应用并保存其 URL。",
    createStepRegistry: "将门店信息发送给 Misemaru Cloud 以完成验证。",
    copyStep1: "打开下方模板，选择“文件 → 创建副本”。",
    copyStep2: "保存到您的 Google 云端硬盘。",
    copyStep3: "系统会自动生成对应的 Apps Script 项目。",
    openTemplate: "📄 打开模板",
    timezoneTitle: "设置时区",
  ...
  es: {
    ...
    createStepSpreadsheet: "Copia la hoja de cálculo plantilla.",
    ...
    copyStep1: "Abre la plantilla y selecciona “Archivo → Hacer una copia”.",
    copyStep2: "Guárdala en tu Google Drive.",
    copyStep3: "Se creará automáticamente un proyecto de Apps Script vinculado.",
  ...
  ko: {
    ...
    createStepSpreadsheet: "템플릿 스프레드시트를 복사합니다.",
    createStepDeploy: "GAS를 웹 앱으로 배포하고 URL을 기록합니다.",
    createStepRegistry: "매장 정보를 Misemaru Cloud로 보내 인증을 요청합니다.",
    copyStep1: "아래 템플릿을 열고 “파일 → 사본 만들기”를 선택하세요.",
    copyStep2: "Google 드라이브에 저장합니다.",
    copyStep3: "복사 시 자동으로 Apps Script 프로젝트가 생성됩니다.",
    openTemplate: "📄 템플릿 열기",
